	...
	public static void main(String[] args) {
		...
		try {
			...
			criminal.forEach(Crime -> {
				System.out.println("Criminal ID :" + Crime.getCriminal_Id());
				System.out.println("Criminal Name :" + Crime.getCriminal_Name());
				System.out.println("Criminal Age: " + Crime.getAge());
				System.out.println("Criminal Gender: " + Crime.getGender());
				...
				System.out.println("Criminal IdentifyingMark: " + Crime.getIdentifyingMark());
